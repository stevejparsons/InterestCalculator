...
{
    public class InterestResult : IInterestResult
    {
        public InterestResult(decimal totalInvested, IEnumerable<decimal> wideBoundUpperSeries,
        ...
        public InterestResult(string errorMessage)
        {
            Success = false;
