...
namespace BusinessLayer.Tests
{
    ...
    public class InterestCalculatorTests
    {
        ...
        public void Calculate__100000LumpSum_2000MonthlyInvestment_ZeroPercent__CalculatesNext10YearsCorrectly()
        {
            ...
            var firstTenYears = interest.Skip(11).Take(10).ToList();
        ...
        public void Calculate__100000LumpSum_NoMonthlyInvestment_5Percent__CalculatesFirst10YearsCorrectly()
        {
            ...
            Assert.AreEqual(100000m, firstTenYears[0]);
            Assert.AreEqual(105000m, firstTenYears[1]);
            Assert.AreEqual(110250m, firstTenYears[2]);
            Assert.AreEqual(115762.5m, firstTenYears[3]);
            Assert.AreEqual(121550.63m, firstTenYears[4]);
            Assert.AreEqual(127628.16m, firstTenYears[5]);
            Assert.AreEqual(134009.56m, firstTenYears[6]);
            Assert.AreEqual(140710.04m, firstTenYears[7]);
            Assert.AreEqual(147745.54m, firstTenYears[8]);
            Assert.AreEqual(155132.82m, firstTenYears[9]);
            Assert.AreEqual(162889.46m, firstTenYears[10]);
        }
        ...
        public void Calculate__100000LumpSum_1000MonthlyInvestment_5Percent__CalculatesFirst10YearsCorrectly()
        {
            ...
            Assert.AreEqual(100000.00m, firstTenYears[0]);
            Assert.AreEqual(117272.58m, firstTenYears[1]);
            Assert.AreEqual(135408.78m, firstTenYears[2]);
            Assert.AreEqual(154451.80m, firstTenYears[3]);
            Assert.AreEqual(174446.97m, firstTenYears[4]);
            Assert.AreEqual(195441.89m, firstTenYears[5]);
            Assert.AreEqual(217486.57m, firstTenYears[6]);
            Assert.AreEqual(240633.47m, firstTenYears[7]);
            Assert.AreEqual(264937.72m, firstTenYears[8]);
            Assert.AreEqual(290457.19m, firstTenYears[9]);
            Assert.AreEqual(317252.62m, firstTenYears[10]);
        }
